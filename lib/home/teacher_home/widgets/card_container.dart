...
// class ParentfStudent extends StatelessWidget {
//   const ParentofStudent({Key? key, required this.parentOfStudent}) : super(key: key);
//   final String parentOfStudent;
//   @override
//   Widget build(BuildContext context) {
//     return Text(parentOfStudent}, style: Theme.of(context).textTheme.subtitle2);)
//   }
// }
