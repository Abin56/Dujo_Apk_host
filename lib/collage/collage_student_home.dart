...
class CollegeStudentHome extends StatefulWidget {
  const CollegeStudentHome({super.key});

  @override
  State<CollegeStudentHome> createState() => _CollegeStudentHomeState();
}

class _CollegeStudentHomeState extends State<CollegeStudentHome> {
