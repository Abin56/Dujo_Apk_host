...
class CollegeFaculatyHome extends StatefulWidget {
  const CollegeFaculatyHome({super.key});

  @override
  State<CollegeFaculatyHome> createState() => _CollegeFaculatyHomeState();
}

class _CollegeFaculatyHomeState extends State<CollegeFaculatyHome> {
