...
import 'package:dujo_application/signing/dujosigning.dart';
...
import '../phone_otp/Student_otp/student_verify_otp_screen.dart';
...
class StuentDujoSignup extends StatelessWidget {
  ...
  StuentDujoSignup({required this.schoolID, this.classID, super.key});
